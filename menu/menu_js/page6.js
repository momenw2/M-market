// API URLs
const apiUrl = 'https://food-delivery.kreosoft.ru/api/dish?vegetarian=false&page=6';
...
vegetarianToggle.addEventListener('change', () => {
    ...
    const apiUrlWithFilters = `https://food-delivery.kreosoft.ru/api/dish?vegetarian=${vegetarian}&page=6`;
