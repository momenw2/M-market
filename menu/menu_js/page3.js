// API URLs
const apiUrl = 'https://food-delivery.kreosoft.ru/api/dish?vegetarian=false&page=3';
...
vegetarianToggle.addEventListener('change', () => {
    ...
    const apiUrlWithFilters = `https://food-delivery.kreosoft.ru/api/dish?vegetarian=${vegetarian}&page=3`;
