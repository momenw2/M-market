// API URLs
const apiUrl = 'https://food-delivery.kreosoft.ru/api/dish?vegetarian=false&page=7';
...
vegetarianToggle.addEventListener('change', () => {
    ...
    const apiUrlWithFilters = `https://food-delivery.kreosoft.ru/api/dish?vegetarian=${vegetarian}&page=7`;
