...
// // Modify the sendDishesToOrder function to use the calculated delivery time
// async function sendDishesToOrder() {
//   async function sendDishesToOrder() {
//     try {
//       const token = await getToken();
...
//   // Open a new page
//   window.open('../html/createOrder.html');

//   // Retrieve the items from the cart
//   const cartItems = JSON.parse(localStorage.getItem('cartItems')) || [];

//   // Display the cart items in the new page
//   const cartItemsContainer = window.opener.document.getElementById('cart-items');
